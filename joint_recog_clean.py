...
if opt.recog_dir == None:
    opt = fake_opt.joint_recog_check()
...
#opt.recog_dir = '/usr/home/shi/projects/data_aishell/data/kang_test_clean'
recog_dataset = SequentialDataset(opt, opt.recog_dir, os.path.join(opt.dict_dir, 'train_units_k.txt'),type_data) 
