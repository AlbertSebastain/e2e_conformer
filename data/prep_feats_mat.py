...
def main():
    ...
    # 读取noise的路径
    noise_wav_list = []
    for (dirpath, dirnames, filenames) in walk("/usr/home/shi/projects/data_aishell/data/noise"):
        noise_wav_list = [os.path.join("/usr/home/shi/projects/data_aishell/data/noise",x) for x in filenames if x.split(".")[-1] == "mat"]
        break
